    ...
    return(
        ...
        <div className="row align-items-center">
            <div className="col-sm-12 col-md-6">
                <h4 className="mt-5 fw-bold text-secondary">Acerca de</h4>
                ...
                Creamos este sitio web con contenido multimedia compuesto por fotos, audios, textos y videos para poder brindar una mayor adecuación a las diferentes modalidades en que los alumnos pueden presentar su trabajo final de la carrera.<br/>
            ...
            <div className="col-sm-12 col-md-6">
                <img src="/img/eg.png" alt="egresados" className="img-main" />
            </div>
        </div>
        ...
        <div className="col-sm-12 col-md-6">
                <img src="/img/biblio.jpg" alt="bibliografia" className="img-main" />
            </div>
            <div className="col-sm-12 col-md-6">
                <h4 className="mt-5 fw-bold text-secondary">Derechos de autor</h4>
                <hr className="border border-secondary border-1"/>
                <p>
        ...
        <div className="row align-items-center mt-5 mb-5">
            ...
            <div className="col-sm-12 col-md-6">
                <h4 className="mt-5 fw-bold text-secondary">Contácto</h4>
                <hr className="border border-secondary border-1"/>
                <p>
